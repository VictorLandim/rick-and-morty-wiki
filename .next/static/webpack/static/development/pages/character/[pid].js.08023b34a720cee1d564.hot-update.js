...
const CharacterDetails = () => {
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_1___default.a.Fragment, null, __jsx(_chakra_ui_core__WEBPACK_IMPORTED_MODULE_5__["Button"], {
    size: "sm",
    leftIcon: "arrow-back",
    __source: {
      fileName: _jsxFileName,
    ...
    __self: undefined
  }, "Go back"), __jsx(_chakra_ui_core__WEBPACK_IMPORTED_MODULE_5__["Box"], {
    padding: {
      md: '20px',
      sm: '20px',
      xs: '20px'
...
//# sourceMappingURL=[pid].js.08023b34a720cee1d564.hot-update.js.map